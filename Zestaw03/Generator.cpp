...
auto main(int argc, char* argv[]) -> int
{
    ...
    std::mt19937 gen(rd());
    std::uniform_int_distribution<int> r_num(0, 10000);
    std::uniform_int_distribution<int> r_type(0, 5);
    ...
    for (int i = 0; i < number_of_operations; ++i)
    {
        ...
        {
        case 0:
            std::cout << "F " << r_num(gen) << std::endl;
            break;
        case 1:
            std::cout << "B " << r_num(gen) << std::endl;
            break;
        case 2:
            std::cout << "f" << std::endl;
            break;
        case 3:
            ...
            break;
        case 4:
            std::cout << "R " << r_num(gen) << " " << r_num(gen) << std::endl;
            break;
        case 5:
            std::cout << "S" << std::endl;
            break;
